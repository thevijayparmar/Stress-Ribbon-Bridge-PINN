...
def generate_bridge_data():
    spans = [3, 8, 35, 155, 220, 550, 1600, 1950]
    height_diffs = [0.25, 1.5, 5, 10.5, 25, 42, 49.50]
    udls = [0.7, 7, 12, 19, 24.99, 48, 80, 165]
    t_allows = [8, 25, 80, 250, 3000, 18000, 260000, 980000]
    sag_percents = [0.3, 0.8, 1, 2, 4.5, 7, 60, 120, 450]
