...
def generate_bridge_data():
    spans = [4, 6, 12, 18, 22, 28, 32, 38, 42, 48, 52, 58, 286]
    height_diffs = [0.1, 0.75, 1.5, 2.5, 3.5, 6.5, 9.5, 12.5, 25.5, 37.5, 48.4]
    udls = [2, 7.5, 12.5, 17.5, 22.5, 37.5, 62.5, 87.5]
    t_allows = [3, 7, 20, 75, 150, 250, 750, 1250, 1750, 2250, 2750, 3250, 3750, 4250, 4750, 7250, 7750, 8250, 8750, 9250, 15000, 27500, 32500, 37500, 42500, 47500, 57500, 62500, 67500, 72500, 77500, 82500, 185000]
    sag_percents = [0.5, 1.5, 3.5, 6.5, 8.5, 11, 13.5, 18, 28, 33, 86, 99.5]
